...
import com.priyansh.entity.DocumentChunk;
import com.priyansh.entity.MyUser;
import com.priyansh.jwt.JwtUtil;
import com.priyansh.mail.MailSending;
import com.priyansh.repo.DocumentRepo;
import com.priyansh.service.AiService;
import com.priyansh.service.DocumentService;
import com.priyansh.service.UserService;
...
//	}
	...
	@GetMapping("/viewPdf")
	public void viewPdf(@RequestParam(required = false) Long id, HttpServletResponse response) throws IOException {
	    
	    // ✅ Return empty response if no id
	    if (id == null) {
